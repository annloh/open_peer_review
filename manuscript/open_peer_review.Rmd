...
TRS_data_os <- readRDS(file = "../data/royal_society_data_os.rds")
TRS_data_ob <- readRDS(file = "../data/royal_society_data_ob.rds")
# Combine both datasets into one.
TRS_data <- rbind(TRS_data_os, TRS_data_ob)

#Read in PeerJ data
PeerJ_main_data <- readRDS(file = "../data/peerj_data.rds")
PeerJ_cs_data <- readRDS(file = "../data/peerj_cs_data.rds")
# Combine both datasets into one.
...
open_review_PeerJ <- nrow(PeerJ_unique)/length(list.files(path = "./data/peerj_reviews_txt"))
...
OS_pdf_list <- readLines(file("../data/royal_society_pdf_files/OS_pdf_list.txt", open = "r"))

open_review_TRS <- length(OS_pdf_list) / length(read.csv("../data/scopus_export_rsos.csv", stringsAsFactors = FALSE)$DOI)

# How many entries in RSOS in total? Read in scopus datafile
TRS_scopus_OS <- read.csv("../data/scopus_export_rsos.csv", stringsAsFactors = FALSE)
...
# How many entries in RSOS in total? Read in scopus datafile
TRS_scopus_OB <- read.csv("../data/scopus_export_rsob.csv", stringsAsFactors = FALSE)
